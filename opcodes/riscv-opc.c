...
{"vadd.vv",    "I", "Vb,Vh,Vf,Vn",  MATCH_VADD_VV, MASK_VADD_VV, match_opcode, 0 },
{"vadd.vv",    "I", "Vb,Vh,Vf",     MATCH_VADD_VV | (0b0 << 25), MASK_VADD_VV | (0b1 << 25), match_opcode, 0 },
{"vadd.vs",    "I", "Vb,Vh,s,Vn",   MATCH_VADD_VS, MASK_VADD_VS, match_opcode, 0 },
{"vadd.vs",    "I", "Vb,Vh,s",      MATCH_VADD_VS | (0b0 << 25), MASK_VADD_VS | (0b1 << 25), match_opcode, 0 },
{"vadd.vi",    "I", "Vb,Vh,Vi,Vn",  MATCH_VADD_VI, MASK_VADD_VI, match_opcode, 0 },
{"vadd.vi",    "I", "Vb,Vh,Vi",     MATCH_VADD_VI | (0b0 << 25), MASK_VADD_VI | (0b1 << 25), match_opcode, 0 },

{"vfadd.vv",    "I", "Vb,Vh,Vf,Vn",  MATCH_VFADD_VV, MASK_VFADD_VV, match_opcode, 0 },
{"vfadd.vv",    "I", "Vb,Vh,Vf",     MATCH_VFADD_VV | (0b0 << 25), MASK_VFADD_VV | (0b1 << 25), match_opcode, 0 },
{"vfadd.vf",    "I", "Vb,Vh,s,Vn",   MATCH_VFADD_VF, MASK_VFADD_VF, match_opcode, 0 },
{"vfadd.vf",    "I", "Vb,Vh,s",      MATCH_VFADD_VF | (0b0 << 25), MASK_VFADD_VF | (0b1 << 25), match_opcode, 0 },

{"vmul.vv",    "I", "Vb,Vh,Vf,Vn",  MATCH_VMUL_VV, MASK_VMUL_VV, match_opcode, 0 },
{"vmul.vv",    "I", "Vb,Vh,Vf",     MATCH_VMUL_VV | (0b0 << 25), MASK_VMUL_VV | (0b1 << 25), match_opcode, 0 },
{"vmul.vs",    "I", "Vb,Vh,s,Vn",   MATCH_VMUL_VS, MASK_VMUL_VS, match_opcode, 0 },
{"vmul.vs",    "I", "Vb,Vh,s",      MATCH_VMUL_VS | (0b0 << 25), MASK_VMUL_VS | (0b1 << 25), match_opcode, 0 },

{"vfmul.vv",    "I", "Vb,Vh,Vf,Vn",  MATCH_VFMUL_VV, MASK_VFMUL_VV, match_opcode, 0 },
{"vfmul.vv",    "I", "Vb,Vh,Vf",     MATCH_VFMUL_VV | (0b0 << 25), MASK_VFMUL_VV | (0b1 << 25), match_opcode, 0 },
{"vfmul.vf",    "I", "Vb,Vh,s,Vn",   MATCH_VFMUL_VF, MASK_VFMUL_VF, match_opcode, 0 },
{"vfmul.vf",    "I", "Vb,Vh,s",      MATCH_VFMUL_VF | (0b0 << 25), MASK_VFMUL_VF | (0b1 << 25), match_opcode, 0 },

{"vredsum.vs",    "I", "d,Vh,Vf,Vn",  MATCH_VREDSUM_VS, MASK_VREDSUM_VS, match_opcode, 0 },
{"vredsum.vs",    "I", "d,Vh,Vf",     MATCH_VREDSUM_VS | (0b0 << 25), MASK_VREDSUM_VS | (0b1 << 25), match_opcode, 0 },

{"vfredsum.vs",    "I", "d,Vh,Vf,Vn",  MATCH_VFREDSUM_VS, MASK_VFREDSUM_VS, match_opcode, 0 },
{"vfredsum.vs",    "I", "d,Vh,Vf",     MATCH_VFREDSUM_VS | (0b0 << 25), MASK_VFREDSUM_VS | (0b1 << 25), match_opcode, 0 },

{"vext.x.s",    "I", "d,Vh,Vf,Vn",  MATCH_VEXT_X_S, MASK_VEXT_X_S, match_opcode, 0 },
{"vext.x.s",    "I", "d,Vh,Vf",     MATCH_VEXT_X_S | (0b0 << 25), MASK_VEXT_X_S | (0b1 << 25), match_opcode, 0 },

{"vmv.s.x",    "I", "Vb,s,Vn",  MATCH_VMV_S_X | (0b11111 << 20), MASK_VMV_S_X | (0b11111 << 20), match_opcode, 0 },
{"vmv.s.x",    "I", "Vb,s",     MATCH_VMV_S_X | (0b0 << 25) | (0b11111 << 20), MASK_VMV_S_X | (0b1 << 25) | (0b11111 << 20), match_opcode, 0 },

{"vslideup.vx",    "I", "Vb,Vh,s,Vn",   MATCH_VSLIDEUP_VX, MASK_VSLIDEUP_VX, match_opcode, 0 },
{"vslideup.vx",    "I", "Vb,Vh,s",      MATCH_VSLIDEUP_VX | (0b0 << 25), MASK_VSLIDEUP_VX | (0b1 << 25), match_opcode, 0 },
{"vslideup.vi",    "I", "Vb,Vh,Vi,Vn",  MATCH_VSLIDEUP_VI, MASK_VSLIDEUP_VI, match_opcode, 0 },
{"vslideup.vi",    "I", "Vb,Vh,Vi",     MATCH_VSLIDEUP_VI | (0b0 << 25), MASK_VSLIDEUP_VI | (0b1 << 25), match_opcode, 0 },

{"vslidedown.vx",    "I", "Vb,Vh,s,Vn",   MATCH_VSLIDEDOWN_VX, MASK_VSLIDEDOWN_VX, match_opcode, 0 },
{"vslidedown.vx",    "I", "Vb,Vh,s",      MATCH_VSLIDEDOWN_VX | (0b0 << 25), MASK_VSLIDEDOWN_VX | (0b1 << 25), match_opcode, 0 },
{"vslidedown.vi",    "I", "Vb,Vh,Vi,Vn",  MATCH_VSLIDEDOWN_VI, MASK_VSLIDEDOWN_VI, match_opcode, 0 },
{"vslidedown.vi",    "I", "Vb,Vh,Vi",     MATCH_VSLIDEDOWN_VI | (0b0 << 25), MASK_VSLIDEDOWN_VI | (0b1 << 25), match_opcode, 0 },

{"vle",    "I", "Vb,(s),Vn",  MATCH_VLE, MASK_VLE, match_opcode, 0 },
{"vle",    "I", "Vb,(s)",     MATCH_VLE | (0b0 << 25), MASK_VLE | (0b1 << 25), match_opcode, 0 },

{"vse",    "I", "Vb,(s),Vn",     MATCH_VSE, MASK_VSE , match_opcode, 0 },
{"vse",    "I", "Vb,(s)",  MATCH_VSE | (0b0 << 25), MASK_VSE | (0b1 << 25), match_opcode, 0 },

{"vlxe",    "I", "Vb,(s),Vh,Vn",     MATCH_VLXE, MASK_VLXE , match_opcode, 0 },
{"vlxe",    "I", "Vb,(s),Vh",  MATCH_VLXE | (0b0 << 25), MASK_VLXE | (0b1 << 25), match_opcode, 0 },

{"vsxe",    "I", "Vb,(s),Vh,Vn",     MATCH_VSXE, MASK_VSXE , match_opcode, 0 },
{"vsxe",    "I", "Vb,(s),Vh",  MATCH_VSXE | (0b0 << 25), MASK_VSXE | (0b1 << 25), match_opcode, 0 },


{"vsetvl",    "I", "d,s,t",  MATCH_VSETVL, MASK_VSETVL, match_opcode, 0 },
{"vsetvli",   "I", "d,s,Vo",  MATCH_VSETVLI, MASK_VSETVLI, match_opcode, 0 },
